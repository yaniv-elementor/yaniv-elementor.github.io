...
var MS, MOZ, WEBKIT, COMMENT, RULESET, DECLARATION, MEDIA, IMPORT, SUPPORTS, KEYFRAMES;
var init_Enum = __esm({
  "node_modules/stylis/src/Enum.js"() {
    MS = "-ms-";
    MOZ = "-moz-";
...
var identifierWithPointTracking, toRules, getRules, fixedElements, compat, removeLabel, ignoreFlag, isIgnoringComment, createUnsafeSelectorsAlarm, isImportRule, isPrependedWithRegularRules, nullifyElement, incorrectImportAlarm, prefixer2, defaultStylisPlugins, createCache, emotion_cache_browser_esm_default;
var init_emotion_cache_browser_esm = __esm({
  "node_modules/@emotion/cache/dist/emotion-cache.browser.esm.js"() {
    ...
    prefixer2 = function prefixer3(element, index, children, callback) {
      if (element.length > -1) {
        if (!element["return"])
          switch (element.type) {
            case DECLARATION:
    ...
    defaultStylisPlugins = [prefixer2];
...
var import_react2, import_hoist_non_react_statics2, pkg, warnedAboutCssPropForGlobal, Global, keyframes, classnames, Insertion3, ClassNames, isBrowser2, isTestEnv, globalContext, globalKey;
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LTODIF4Y.js.map
