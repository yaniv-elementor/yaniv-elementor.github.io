...
import MuiAppBar$1 from '@mui/material/AppBar';
import MuiToolbar from '@mui/material/Toolbar';
import MuiSvgIcon from '@mui/material/SvgIcon';
import MuiStack from '@mui/material/Stack';
import MuiIconButton$1 from '@mui/material/IconButton';
...
const AppBar = React.forwardRef((props, ref) => {
    return (React.createElement(MuiAppBar$1, { ...props, ref: ref }));
});

const Toolbar = React.forwardRef((props, ref) => {
    return (React.createElement(MuiToolbar, { ...props, ref: ref }));
});

const SvgIcon = React.forwardRef((props, ref) => {
    return (React.createElement(MuiSvgIcon, { ...props, ref: ref }));
});

const Stack = React.forwardRef((props, ref) => {
    return (React.createElement(MuiStack, { ...props, ref: ref }));
});

// Modified reason: Material UI Typescript problem with the 'component' prop.
const IconButton = React.forwardRef((props, ref) => {
    return (React.createElement(MuiIconButton$1, { ...props, ref: ref }));
});
...
const Root$1 = styled(IconButton, slots$1.root)({});
const Icon = styled(XIcon, slots$1.icon)({});
const CloseButton = React.forwardRef((inProps, ref) => {
    ...
    return (React.createElement(Root$1, { ...rootProps, size: "small", ref: ref, className: clsx([[classNames$1.root, rootProps.className]]), ownerState: props },
        React.createElement(Icon, { ...slotProps.icon, className: clsx([classNames$1.icon, slotProps.icon?.className]), ownerState: props })));
});
...
const Root = styled(AppBar, slots.root)({
    '& .MuiDialogTitle-root': {
        padding: 0,
    },
});
const ToolbarSlot = styled(Toolbar, slots.toolbar)({});
const DialogHeader = React.forwardRef((inProps, ref) => {
    ...
    return (React.createElement(Root, { ...rootProps, ref: ref, className: clsx([[classNames.root, rootProps.className]]), ownerState: props },
        React.createElement(ToolbarSlot, { variant: "dense", ...slotProps.toolbar, className: clsx([classNames.toolbar, slotProps.toolbar?.className]), ownerState: props },
            React.createElement(Logo, { logo: logo, className: clsx([classNames.logo, slotProps.logo?.className]) }),
