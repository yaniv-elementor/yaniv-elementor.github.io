...
const { slots, classNames } = createSlots('AlertAction', ['root']);
const Root = styles.styled(Button, slots.root)({});
const AlertAction = React__default["default"].forwardRef((inProps, ref) => {
    const props = styles.useThemeProps({ props: inProps, name: slots.root.name });
    return (React__default["default"].createElement(Root, { ...props, size: "small", ref: ref, className: clsx__default["default"]([[classNames.root, props.className]]), ownerState: props }));
});
