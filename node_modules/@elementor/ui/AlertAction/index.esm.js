...
const Button = React.forwardRef((props, ref) => {
    ...
    return (React.createElement(MuiButton$1, { ...props, sx: {
            ...linkSx,
            ...sx,
        }, ref: ref }));
});
...
const Root = styled(Button, slots.root)({});
const AlertAction = React.forwardRef((inProps, ref) => {
    const props = useThemeProps({ props: inProps, name: slots.root.name });
    return (React.createElement(Root, { ...props, size: "small", ref: ref, className: clsx([[classNames.root, props.className]]), ownerState: props }));
});
