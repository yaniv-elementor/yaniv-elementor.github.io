...
import { createTheme, styled, useThemeProps, alpha } from '@mui/material/styles';
...
const Root = styled(IconButton, slots$1.root)({});
...
const CloseButton = React.forwardRef((inProps, ref) => {
    ...
    return (React.createElement(Root, { ...rootProps, size: "small", ref: ref, className: clsx([[classNames$1.root, rootProps.className]]), ownerState: props },
...
const StyledAlertContent = styled('div', slots.content)(() => ({
    flexGrow: 1,
    paddingTop: '6px',
}));
const StyledAlertContentInnerContainer = styled('div', slots.content)(({ theme }) => ({
    alignItems: 'center',
    display: 'flex',
    flexWrap: 'wrap',
...
const Alert = React.forwardRef(({ onClose, action, secondaryAction, children, ...props }, ref) => {
    ...
    return (React.createElement(StyledAlert, { iconMapping: {
            ...
            : false },
        React.createElement(AlertContent, { className: classNames.content }, children),
        hasActions && (React.createElement(StyledAlertActions, { className: classNames.actions },
            secondaryAction,
            action))));
});
Alert.defaultProps = {
