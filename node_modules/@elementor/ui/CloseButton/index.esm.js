...
const Root = styled(IconButton, slots.root)({});
const Icon = styled(XIcon, slots.icon)({});
const CloseButton = React.forwardRef((inProps, ref) => {
    ...
    return (React.createElement(Root, { ...rootProps, size: "small", ref: ref, className: clsx([[classNames.root, rootProps.className]]), ownerState: props },
        React.createElement(Icon, { ...slotProps.icon, className: clsx([classNames.icon, slotProps.icon?.className]), ownerState: props })));
});
