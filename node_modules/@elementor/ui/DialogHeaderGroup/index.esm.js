...
const Box = React.forwardRef((props, ref) => {
    return (React.createElement(MuiBox, { ...props, ref: ref }));
});
...
const Root = styled(Box, slots.root)(({ theme, ownerState }) => {
...
const DialogHeaderGroup = React.forwardRef((inProps, ref) => {
    ...
    return (React.createElement(Root, { ...rootProps, ref: ref, className: clsx([[classNames.root, rootProps.className]]), ownerState: ownerState }));
});

export { DialogHeaderGroup as default };
