...
const Box = React__default["default"].forwardRef((props, ref) => {
    return (React__default["default"].createElement(MuiBox__default["default"], { ...props, ref: ref }));
});
...
const { slots, classNames } = createSlots('DialogHeaderGroup', ['root']);
const Root = styles.styled(Box, slots.root)(({ theme, ownerState }) => {
...
const DialogHeaderGroup = React__default["default"].forwardRef((inProps, ref) => {
    ...
    return (React__default["default"].createElement(Root, { ...rootProps, ref: ref, className: clsx__default["default"]([[classNames.root, rootProps.className]]), ownerState: ownerState }));
});

exports["default"] = DialogHeaderGroup;
